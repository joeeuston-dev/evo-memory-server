...
# LEGACY FUNCTION - DEPRECATED IN FAVOR OF DynamicToolProvider
def create_mcp_server_legacy(memory: Neo4jMemory, description_manager: DynamicToolDescriptionManager = None) -> FastMCP:
    """DEPRECATED: Create an MCP server instance for memory management."""
